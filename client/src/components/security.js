    ...
    >
      ...
      <div className="container py-4 flex-grow-1">
        ...
        <div className="d-flex justify-content-center gap-2 mb-2 flex-wrap">
          ...
          >
            <FaFilter className="me-2" />All ({visitors.length})
          </button>
          <button
          ...
          >
            Checked In ({visitors.filter((v) => v.status === "checkedIn").length})
          </button>
          <button
          ...
          >
            Checked Out ({visitors.filter((v) => v.status === "checkedOut").length})
          </button>
        </div>
            ...
            <div className="modal-dialog modal-dialog-centered">
              <div className="modal-content p-4 rounded-4">
                ...
                <div className="text-center mt-4">
                  <button className="btn btn-success btn-sm rounded-pill shadow px-4" onClick={saveBadgeNo}>
                    Save
                  </button>
                </div>
              </div>
